...
import type { IAffiliate, ICommission, IAffiliateWithdrawal, ITenant, IPlatformSettings } from '../../types';
import {
    Wallet,
    Copy,
    CheckCircle2,
            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                {currentAffiliate && (
                    <div className="animate-in fade-in duration-700 space-y-8">
                        {(() => {
                            let effectiveRate = currentAffiliate.commission_rate || settings?.commission_rate_default || 10;
                            let isPromo = false;
                            ...
                            if (settings?.commission_promo_rate && settings?.commission_promo_expires_at && new Date(settings.commission_promo_expires_at) > new Date()) {
                                effectiveRate = settings.commission_promo_rate;
                                isPromo = true;
                            }
                            return (
                                <>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                        <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm flex items-center gap-4 transition-all hover:shadow-md">
                                            ...
                                            <div>
                                                <div className="text-[10px] font-black uppercase tracking-wider text-slate-400">Saldo Tersedia</div>
                                                <div className="text-xl font-black text-slate-900 dark:text-white mt-0.5">{formatCurrencyRp(currentAffiliate.balance)}</div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm flex items-center gap-4 transition-all hover:shadow-md">
                                            ...
                                            <div>
                                                <div className="text-[10px] font-black uppercase tracking-wider text-slate-400">Total Pendapatan</div>
                                                <div className="text-xl font-black text-slate-900 dark:text-white mt-0.5">{formatCurrencyRp(currentAffiliate.total_earned || 0)}</div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm flex items-center gap-4 transition-all hover:shadow-md">
                                            ...
                                            <div>
                                                <div className="text-[10px] font-black uppercase tracking-wider text-slate-400">Referred Masjid</div>
                                                <div className="text-xl font-black text-slate-900 dark:text-white mt-0.5">{referredTenants.length}</div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm flex items-center gap-4 transition-all hover:shadow-md">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-xl font-black text-slate-900 dark:text-white mt-0.5 flex items-center gap-2">
                                                    {effectiveRate}%
                                                    {isPromo && <span className="text-[9px] font-black text-emerald-500 bg-emerald-50 dark:bg-emerald-900/30 px-2 py-0.5 rounded-full animate-pulse tracking-widest">PROMO</span>}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
